...
const Info = () => {
  return (
    ...
    h-screen
    flex items-center
    pt-28 px-11 bg-gradient-to-t from-black via-transparent to-black">
      <div className='
      rounded-lg py-5 px-10 w-11/12 max-w-fit h-fit' style={{background:' linear-gradient(to right ,#c2400cd3 ,#431407d3)'}}>
        ...
        <p className='text-orange-100 font-thin text-md'>
          <b className='font-bold'>Top search:</b> Dandadan, Blue Lock, One Piece,<br/>Bleach: Thousand-Year Blo..., Blue Lock Season 2,<br/>Bleach: Thousand-Year Blo...,My Hero Academia season...<br/>Uzumaki: Spiral into Horror,Wistoria: Wand and Sword,Bleach,...<br/>
        </p>
        <Link href='/AnimeList' >
